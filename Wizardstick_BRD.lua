...
function get_sets()
    ...
    sets.midcast.song.ballad = sets.midcast.song.buff --set_combine(sets.midcast.song.buff, {legs="Fili rhingrave +3"})
    ...
    sets.midcast.song.threnody = set_combine(sets.midcast.song.buff, {body="Mousai manteel +1"})
